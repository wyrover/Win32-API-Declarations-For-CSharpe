...
namespace Win32
{
	...
	public class User
	{
        ...
        [DllImport("user32")] public static extern int EnumChildWindows(HWND hwndParent, EnumChildWindowsCallBack lpEnumFunc, int lParam);
        ...
        public delegate Boolean EnumChildWindowsCallBack(IntPtr hwnd, IntPtr lParam);
